	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function addTodo(todoItem) {
	      ...
	      this.allChecked();
	      thisl.db.set("todos", this.state.todos);
	    }
	  }, {
	    key: "changeTodoState",
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(_TodoFooter2["default"], _extends({ isAllChecked: this.state.isAllChecked, clearDone: this.clearDone.bind(this) }, props, { changeTodoState: this.changeTodoState.bind(this) }))
	      );
	    }
	  }]);
	  ...
	  _createClass(TodoFooter, [{
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement("input", { checked: this.props.isAllChecked, onChange: this.handlerAllState.bind(this), type: "checkbox", className: "f1" }),
	        _react2["default"].createElement(
	          "span",
	          { className: "f1" },
